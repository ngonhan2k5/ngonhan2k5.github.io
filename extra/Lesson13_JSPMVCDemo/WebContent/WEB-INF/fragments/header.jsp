<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <form class="form-inline my-2 my-lg-0" method="POST" action="contact-messages">
                <input class="form-control mr-sm-2" type="text" name="keyword" value="${keyword}" placeholder="Search">
