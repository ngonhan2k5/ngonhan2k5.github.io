...
function testAll(){
    ...
    // Q8
    test.info('Q8 - computeSumOfSquares');
    ...
    test.info('Q12 - findSecondBiggest');
    ...
    test.info('Q13 - findSecondBiggest');
